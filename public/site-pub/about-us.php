...
<head>
    <meta charset="utf-8" />
    <title>About us - Hi Choice home page 1</title>
    ...
    <link rel="stylesheet" href="css/v_9150_a4a0b362a9b6f90c5e6e5ca23dfd1294_all.css" type="text/css" media="all" />
    <!--[if IE 8]> 
<script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script> 
<script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script> <![endif]-->
</head>

<body id="cms" class="cms cms-4 cms-about-us hide-left-column hide-right-column lang_en fullwidth">
    ...
    <div id="page">
        ...
        <div class="columns-container">
            <div id="columns" class="container">
                ...
                <div class="row">
                    <div class="container">
                        <div class="breadcrumb title_font clearfix"> <a class="home title_font" href="index.php" title="Return to Home"><span class="title">Home</span></a> <span class="navigation-pipe"><i class="icon-chevron-right"></i></span> About us</div>
                    </div>
                                ...
                                <div class="cms-row block clearfix">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="cms-box">
                                                <p><dfn>Some Text For about us </dfn></p>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="cms-box"><img title="cms-img" src="images/cms-img.jpg" alt="cms-img" height="295" width="570" /></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="cms-row block clearfix">
                                    <h3 class="page-subheading">Our Service</h3>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="cms-box">
                                                <div class="cms-box-line"><em>Product</em>
                                                    <div id="a100" class="cms-line">
                                                        <div class="cms-line-comp"></div>
                                                        <div class="label"><em>.</em></div>
                                                    </div>
                                                </div>
                                                <div class="cms-box-line"><em>quality</em>
                                                    <div id="a100" class="cms-line">
                                                        <div class="cms-line-comp"></div>
                                                        <div class="label"><em>.</em></div>
                                                    </div>
                                                </div>
                                                <div class="cms-box-line"><em>secure payment systems</em>
                                                    <div id="a100" class="cms-line">
                                                        <div class="cms-line-comp"></div>
                                                        <div class="label"><em>.</em></div>
                                                    </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <p> <dfn>Some text for our service.</dfn></p>
...
<!--                                <div class="cms-row block clearfix">
                                    ...
                                    <div class="row">
                                        <div class="cms-box our-team">
                                            <div class="col-xs-6 col-sm-3"><img title="cms-img" src="images/team-1.jpg" alt="cms-img" height="218" width="218" />
                                                <p class="title_font">BRYAN JHONSON</p>
                                                <p>CEO &amp; Co-Founder</p>
                                            </div>
                                            <div class="col-xs-6 col-sm-3"><img title="cms-img" src="images/team-2.jpg" alt="cms-img" height="218" width="218" />
                                                <p class="title_font">JORDAN MARK</p>
                                                <p>Designer</p>
                                            </div>
                                            <div class="col-xs-6 col-sm-3"><img title="cms-img" src="images/team-3.jpg" alt="cms-img" height="218" width="218" />
                                                <p class="title_font">ROKAN TECH</p>
                                                <p>Developer</p>
                                            </div>
                                            <div class="col-xs-6 col-sm-3"><img title="cms-img" src="images/team-4.jpg" alt="cms-img" height="218" width="218" />
    ...
    <script type="text/javascript" src="js/v_4_04602c1cb853a8698a538b4a0020cb7c.js"></script>
