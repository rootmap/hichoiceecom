if (typeof Object.create !== "function") {
    ...
    var i = {
        init: function(t, n) {
            ...
            if (r.options.zoomImage != "") r.imageSrc = r.options.zoomImage;
            if (r.options.tint) {
                r.options.lensColour = "none", r.options.lensOpacity = "1"
            }
            if (r.options.zoomType == "inner") {
                r.options.showLens = false;
                r.options.tint = false
            }
            if (r.options.zoomType == "lens") {
                r.options.tint = false
            }
            ...
            e("#" + r.options.gallery + " a").click(function(t) {
                if (r.options.galleryActiveClass) {
                    e("#" + r.options.gallery + " a").removeClass(r.options.galleryActiveClass);
                    e(this).addClass(r.options.galleryActiveClass)
                }
                t.preventDefault();
                if (e(this).data("zoom-image")) {
                    r.zoomImagePre = e(this).data("image")
                } else {
                    r.zoomImagePre = e(this).data("zoom-image")
                }
        ...
        startZoom: function() {
            ...
            if (t.options.zoomType == "inner") {
                ...
                t.zoomWindowStyle = "overflow: hidden;" + "margin-left: " + String(n) + ";" + "margin-top: " + String(n) + ";" + "background-position: 0px 0px;" + "width: " + String(t.nzWidth) + "px;" + "height: " + String(t.nzHeight) + "px;float: left;" + "display: none;" + "cursor:" + t.options.cursor + ";" + "background-size: " + t.largeWidth / t.currentZoomLevel + "px " + t.largeHeight / t.currentZoomLevel + "px;" + "px solid " + t.options.borderColour + ";background-repeat: no-repeat;" + "position: absolute;"
            }
            if (t.options.zoomType == "window") {
            ...
            t.tintStyle = "display: block;" + "position: absolute;" + "z-index: 990;" + "background-color: " + t.options.tintColour + ";" + "filter:alpha(opacity=0);" + "opacity: 0;" + "width: " + t.nzWidth + "px;" + "height: " + t.nzHeight + "px;";
            t.lensRound = "";
            if (t.options.zoomType == "lens") {
                t.lensStyle = "background-position: 0px 0px;" + "z-index: 999;" + "float: left;display: none;" + "border: " + String(t.options.borderSize) + "px solid " + t.options.borderColour + ";" + "width:" + String(t.options.lensSize) + "px;" + "height:" + String(t.options.lensSize) + "px;" + "background-size: " + t.largeWidth / t.currentZoomLevel + "px " + t.largeHeight / t.currentZoomLevel + "px;" + "background-repeat: no-repeat;position: absolute;"
            }
            ...
            t.zoomContainer = e('<div class="zoomContainer" style="position:absolute;left:' + t.nzOffset.left + "px;top:" + t.nzOffset.top + "px;height:" + t.nzHeight + "px;width:" + t.nzWidth + 'px;"></div>');
            ...
            if (t.options.zoomType != "inner") {
                ...
                if (t.options.tint && t.options.zoomType != "inner") {
                    ...
                    t.zoomTintImage = e('<img style="position: absolute; left: 0px; top: 0px; max-width: none; width: ' + t.nzWidth + "px; height: " + t.nzHeight + 'px;" src="' + t.$elem.attr("src") + '">').appendTo(t.zoomLens).click(function() {
                        t.$elem.trigger("click")
                    })
                }
            }
            ...
            if (t.options.scrollZoom) {
                t.zoomContainer.add(t.$elem).bind("mousewheel DOMMouseScroll MozMousePixelScroll", function(n) {
                    ...
                    var r = n.originalEvent.wheelDelta || n.originalEvent.detail * -1;
        ...
        setWindowPostition: function(t) {
            ...
            if (!isNaN(n.options.zoomWindowPosition)) {
                switch (n.options.zoomWindowPosition) {
                    case 1:
                        ...
                        break;
                    case 2:
                        if (n.options.zoomWindowHeight > n.nzHeight) {
                            n.windowOffsetTop = (n.options.zoomWindowHeight / 2 - n.nzHeight / 2) * -1;
                            n.windowOffsetLeft = n.nzWidth
                        } else {}
                        break;
                    case 3:
                        n.windowOffsetTop = n.nzHeight - n.zoomWindow.height() - n.options.borderSize * 2;
                        n.windowOffsetLeft = n.nzWidth;
                        break;
                    case 4:
                    ...
                    case 5:
                        n.windowOffsetTop = n.nzHeight;
                        n.windowOffsetLeft = n.nzWidth - n.zoomWindow.width() - n.options.borderSize * 2;
                        break;
                    case 6:
                        if (n.options.zoomWindowHeight > n.nzHeight) {
                            n.windowOffsetTop = n.nzHeight;
                            n.windowOffsetLeft = (n.options.zoomWindowWidth / 2 - n.nzWidth / 2 + n.options.borderSize * 2) * -1
                        } else {}
                        break;
                    case 7:
                        n.windowOffsetTop = n.nzHeight;
                    ...
                    case 8:
                        n.windowOffsetTop = n.nzHeight;
                        n.windowOffsetLeft = (n.zoomWindow.width() + n.options.borderSize * 2) * -1;
                        break;
                    case 9:
                        n.windowOffsetTop = n.nzHeight - n.zoomWindow.height() - n.options.borderSize * 2;
                        n.windowOffsetLeft = (n.zoomWindow.width() + n.options.borderSize * 2) * -1;
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        n.windowOffsetTop = (n.zoomWindow.height() + n.options.borderSize * 2) * -1;
                        n.windowOffsetLeft = (n.zoomWindow.width() + n.options.borderSize * 2) * -1;
                        break;
                    case 13:
                        n.windowOffsetTop = (n.zoomWindow.height() + n.options.borderSize * 2) * -1;
            ...
            n.isWindowSet = true;
            n.windowOffsetTop = n.windowOffsetTop + n.options.zoomWindowOffety;
            n.windowOffsetLeft = n.windowOffsetLeft + n.options.zoomWindowOffetx;
            n.zoomWindow.css({
            ...
            n.windowLeftPos = String(((t.pageX - n.nzOffset.left) * n.widthRatio - n.zoomWindow.width() / 2) * -1);
            n.windowTopPos = String(((t.pageY - n.nzOffset.top) * n.heightRatio - n.zoomWindow.height() / 2) * -1);
            if (n.Etoppos) {
                n.windowTopPos = 0
            }
            if (n.Eloppos) {
            ...
            if (n.Eboppos) {
                n.windowTopPos = (n.largeHeight / n.currentZoomLevel - n.zoomWindow.height()) * -1
            }
            if (n.Eroppos) {
                n.windowLeftPos = (n.largeWidth / n.currentZoomLevel - n.zoomWindow.width()) * -1
            }
            if (n.fullheight) {
                n.windowTopPos = 0
            }
            ...
            if (n.options.zoomType == "window" || n.options.zoomType == "inner") {
                if (n.zoomLock == 1) {
                    if (n.widthRatio <= 1) {
                        n.windowLeftPos = 0
                    }
                ...
                if (n.largeHeight < n.options.zoomWindowHeight) {
                    n.windowTopPos = 0
                }
                if (n.largeWidth < n.options.zoomWindowWidth) {
                    n.windowLeftPos = 0
                }
                if (n.options.easing) {
                    if (!n.xp) {
                    ...
                    if (!n.loop) {
                        n.loop = setInterval(function() {
                            ...
                            if (n.scrollingLock) {
                                ...
                                n.yp = n.windowTopPos;
                                n.xp = ((t.pageX - n.nzOffset.left) * n.widthRatio - n.zoomWindow.width() / 2) * -1;
                                n.yp = ((t.pageY - n.nzOffset.top) * n.heightRatio - n.zoomWindow.height() / 2) * -1;
                                if (n.changeBgSize) {
                                    if (n.nzHeight > n.nzWidth) {
                    ...
                    if (n.changeBgSize) {
                        if (n.nzHeight > n.nzWidth) {
                            ...
                            if (n.largeHeight / n.newvaluewidth < n.options.zoomWindowHeight) {
                                n.zoomWindow.css({
                                    "background-size": n.largeWidth / n.newvaluewidth + "px " + n.largeHeight / n.newvaluewidth + "px"
                                })
                            } else {
        ...
        swaptheimage: function(t, n) {
            var r = this;
            var i = new Image;
            if (r.options.loadingIcon) {
                r.spinner = e("<div style=\"background: url('" + r.options.loadingIcon + "') no-repeat center;height:" + r.nzHeight + "px;width:" + r.nzWidth + 'px;z-index: 2000;position: absolute; background-position: center center;"></div>');
                r.$elem.after(r.spinner)
            }
        ...
        swapAction: function(t, n) {
            ...
            r.options.maxZoomLevel = false;
            if (r.options.zoomType == "lens") {
                r.zoomLens.css({
                    backgroundImage: "url('" + n + "')"
                })
            }
            if (r.options.zoomType == "window") {
                r.zoomWindow.css({
                    backgroundImage: "url('" + n + "')"
                })
            }
            ...
            if (r.options.imageCrossfade) {
                ...
                r.$elem.attr("src", t);
                r.$elem.after(o);
                o.stop(true).fadeOut(r.options.imageCrossfade, function() {
                    e(this).remove()
                });
                ...
                if (r.options.tint) {
                    var u = r.zoomTintImage;
                    var a = u.clone();
                    r.zoomTintImage.attr("src", n);
                    r.zoomTintImage.after(a);
                    a.stop(true).fadeOut(r.options.imageCrossfade, function() {
                        e(this).remove()
                    });
                    u.fadeIn(r.options.imageCrossfade);
                    r.zoomTint.css({
            ...
            if (r.options.constrainType) {
                if (r.options.constrainType == "height") {
                ...
                if (r.options.constrainType == "width") {
