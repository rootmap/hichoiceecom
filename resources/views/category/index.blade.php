        ...
        <div class="box box-danger">
            ...
            <form  enctype="multipart/form-data"  method="post" role="form" action="{{url('admin-ecom/category-add')}}">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Thumble Image</label>
                        <input type="file" class="form-control" id="catimage" name="catimage" placeholder="Enter Name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Banner Image</label>
                        <input type="file" class="form-control" id="bannerimage" name="bannerimage" placeholder="Enter Name">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label class="text-center">
                                    <div class="col-md-12"><b><input type="radio" name="layout" value="4" id="layout_2" /> Layout Four</b></div>
                                    <div class="col-md-12">
                                        <BR>
    ...
    $(document).ready(function () {
        ...
        $("#grid").kendoGrid({
            ...
            columns: [
                ...
                {field: "thumb", title: "Thumb", width: "150px"},
                {field: "banner", title: "Banner", width: "150px"},
